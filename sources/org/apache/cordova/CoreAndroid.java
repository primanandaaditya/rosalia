...
class CoreAndroid extends CordovaPlugin {
    ...
    public boolean execute(java.lang.String r8, org.json.JSONArray r9, org.apache.cordova.CallbackContext r10) throws org.json.JSONException {
        ...
        L_0x0011:
            ...
            r5.<init>(r2, r1)     // Catch:{ JSONException -> 0x0031 }
        ...
        L_0x001a:
            ...
            org.apache.cordova.CordovaInterface r5 = r7.cordova     // Catch:{ JSONException -> 0x0031 }
        ...
        L_0x00a9:
            ...
            org.apache.cordova.PluginResult r6 = r7.pendingResume     // Catch:{ all -> 0x00c5 }
            r7.sendEventMessage(r6)     // Catch:{ all -> 0x00c5 }
            r6 = 0
    ...
    public void loadUrl(String url, JSONObject props) throws JSONException {
        LOG.m19d("App", "App.loadUrl(" + url + "," + props + ")");
        int wait = 0;
    ...
    public void overrideBackbutton(boolean override) {
        LOG.m25i("App", "WARNING: Back Button Default Behavior will be overridden.  The backbutton event will be fired!");
        this.webView.setButtonPlumbedToJs(4, override);
    }

    public void overrideButton(String button, boolean override) {
        LOG.m25i("App", "WARNING: Volume Button Default Behavior will be overridden.  The volume event will be fired!");
