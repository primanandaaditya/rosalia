...
public class ConfigXmlParser {
    ...
    public void parse(Context action) {
        ...
        if (id == 0) {
            ...
            if (id == 0) {
                LOG.m22e(TAG, "res/xml/config.xml is missing!");
                return;
            }
        }
    ...
    public void handleStartTag(XmlPullParser xml) {
        ...
        if (strNode.equals("feature")) {
            ...
            if (this.paramType.equals("service")) {
                this.service = xml.getAttributeValue(null, Param.VALUE);
            } else if (this.paramType.equals("package") || this.paramType.equals("android-package")) {
                this.pluginClass = xml.getAttributeValue(null, Param.VALUE);
            } else if (this.paramType.equals("onload")) {
                this.onload = "true".equals(xml.getAttributeValue(null, Param.VALUE));
            }
        } else if (strNode.equals("preference")) {
            this.prefs.set(xml.getAttributeValue(null, "name").toLowerCase(Locale.ENGLISH), xml.getAttributeValue(null, Param.VALUE));
        } else if (strNode.equals(Param.CONTENT)) {
