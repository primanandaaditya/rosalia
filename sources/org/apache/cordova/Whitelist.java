    ...
    private static class URLPattern {
        ...
        public boolean matches(Uri uri) {
            try {
                ...
                LOG.m19d(Whitelist.TAG, e.toString());
                return false;
            }
        }
    }
        ...
        if (this.whiteList != null) {
            try {
                if (origin.compareTo("*") == 0) {
                    LOG.m19d(TAG, "Unlimited access to network resources");
                    this.whiteList = null;
                    return;
                }
                ...
                if (m.matches()) {
                    ...
                    if (("file".equals(scheme) || Param.CONTENT.equals(scheme)) && host == null) {
                        host = "*";
                    }
                ...
                LOG.m21d(TAG, "Failed to add origin %s", origin);
            }
        }
    }
