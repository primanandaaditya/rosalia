...
public class CordovaActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        LOG.m25i(TAG, "Apache Cordova native platform version 5.1.0 is starting");
        LOG.m19d(TAG, "CordovaActivity.onCreate()");
        loadConfig();
    ...
    public void onPause() {
        super.onPause();
        LOG.m19d(TAG, "Paused the activity.");
        if (this.appView != null) {
    ...
    public void onResume() {
        super.onResume();
        LOG.m19d(TAG, "Resumed the activity.");
        if (this.appView != null) {
    ...
    public void onStop() {
        super.onStop();
        LOG.m19d(TAG, "Stopped the activity.");
        if (this.appView != null) {
    ...
    public void onStart() {
        super.onStart();
        LOG.m19d(TAG, "Started the activity.");
        if (this.appView != null) {
    ...
    public void onDestroy() {
        LOG.m19d(TAG, "CordovaActivity.onDestroy()");
        super.onDestroy();
        if (this.appView != null) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        LOG.m19d(TAG, "Incoming Result. Request code = " + requestCode);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        try {
            ...
            LOG.m19d(TAG, "JSONException: Parameters fed into the method are not valid");
            e.printStackTrace();
        }
    }
}
