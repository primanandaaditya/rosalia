...
public class AssetFilesystem extends Filesystem {
    ...
    private void lazyInitCaches() {
        ...
        L_0x002e:
            ...
            org.apache.cordova.LOG.m31w(r3, r5)     // Catch:{ all -> 0x0063 }
        ...
        L_0x0042:
            ...
            org.apache.cordova.LOG.m19d(r3, r5)     // Catch:{ all -> 0x0063 }
            r1 = r2
            goto L_0x002e
        L_0x004e:
            r0 = move-exception
        ...
        L_0x007f:
            ...
            org.apache.cordova.LOG.m19d(r5, r6)     // Catch:{ all -> 0x0063 }
            goto L_0x007e
        L_0x008a:
            r3 = move-exception
            r1 = r2
    ...
    private long getAssetSize(String assetPath) throws FileNotFoundException {
        ...
        try {
            ...
            try {
                ...
                LOG.m19d(LOG_TAG, e.getLocalizedMessage());
                return length;
            }
