...
public class Notification extends CordovaPlugin {
            ...
            public void run() {
                ...
                if (jSONArray.length() > 0) {
                    try {
                        ...
                        LOG.m19d(Notification.LOG_TAG, "JSONException on first button.");
                    }
                }
                if (jSONArray.length() > 1) {
                    try {
                        ...
                        LOG.m19d(Notification.LOG_TAG, "JSONException on second button.");
                    }
                }
                if (jSONArray.length() > 2) {
                    try {
                        ...
                        LOG.m19d(Notification.LOG_TAG, "JSONException on third button.");
                    }
                }
                dlg.setOnCancelListener(new OnCancelListener() {
                    public void onCancel(DialogInterface dialog) {
                        ...
                        dlg.setNegativeButton(jSONArray.getString(0), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.m20d(Notification.LOG_TAG, "JSONException on first button.", (Throwable) e);
                                }
                        ...
                        dlg.setNeutralButton(jSONArray.getString(1), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.m20d(Notification.LOG_TAG, "JSONException on second button.", (Throwable) e);
                                }
                                callbackContext2.sendPluginResult(new PluginResult(Status.OK, result));
                            }
                        });
                        ...
                        dlg.setPositiveButton(jSONArray.getString(2), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.m20d(Notification.LOG_TAG, "JSONException on third button.", (Throwable) e);
                                }
                                callbackContext2.sendPluginResult(new PluginResult(Status.OK, result));
                            }
                        });
    ...
    public synchronized void activityStart(String title, String message) {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                this.spinnerDialog = Notification.this.createProgressDialog(cordova);
                ...
                this.spinnerDialog.setOnCancelListener(new OnCancelListener() {
                    public void onCancel(DialogInterface dialog) {
                        this.spinnerDialog = null;
                    }
                });
    ...
    public synchronized void progressStart(String title, String message) {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                this.progressDialog = Notification.this.createProgressDialog(cordova);
    ...
    @SuppressLint({"NewApi"})
    public Builder createDialog(CordovaInterface cordova) {
    ...
    /* access modifiers changed from: private */
    @SuppressLint({"NewApi"})
    public void changeTextDirection(Builder dlg) {
