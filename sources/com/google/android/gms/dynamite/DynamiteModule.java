    ...
    public static DynamiteModule zza(Context context, zzd zzd2, String str) throws zzc {
        ...
        try {
            ...
            if (zza2.zzaSW == 0 || ((zza2.zzaSW == -1 && zza2.zzaSU == 0) || (zza2.zzaSW == 1 && zza2.zzaSV == 0))) {
                throw new zzc("No acceptable module found. Local version is " + zza2.zzaSU + " and remote version is " + zza2.zzaSV + ".", (zza) null);
                ...
                throw new zzc("VersionPolicy returned invalid code:" + zza2.zzaSW, (zza) null);
            }
        } catch (zzc e) {
            String str2 = "DynamiteModule";
