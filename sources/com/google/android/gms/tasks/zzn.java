...
final class zzn<TResult> extends Task<TResult> {
    ...
    private final void zzDI() {
        synchronized (this.mLock) {
            if (this.zzbMh) {
                this.zzbMg.zza((Task<TResult>) this);
            }
        }
    }
    ...
    public final Task<TResult> addOnCompleteListener(@NonNull Activity activity, @NonNull OnCompleteListener<TResult> onCompleteListener) {
        ...
        this.zzbMg.zza((zzk<TResult>) zze);
    ...
    public final Task<TResult> addOnCompleteListener(@NonNull Executor executor, @NonNull OnCompleteListener<TResult> onCompleteListener) {
        this.zzbMg.zza((zzk<TResult>) new zze<TResult>(executor, onCompleteListener));
        zzDI();
        return this;
    }
    ...
    public final Task<TResult> addOnFailureListener(@NonNull Activity activity, @NonNull OnFailureListener onFailureListener) {
        ...
        this.zzbMg.zza((zzk<TResult>) zzg);
    ...
    public final Task<TResult> addOnFailureListener(@NonNull Executor executor, @NonNull OnFailureListener onFailureListener) {
        this.zzbMg.zza((zzk<TResult>) new zzg<TResult>(executor, onFailureListener));
        zzDI();
        return this;
    }
    ...
    public final Task<TResult> addOnSuccessListener(@NonNull Activity activity, @NonNull OnSuccessListener<? super TResult> onSuccessListener) {
        ...
        this.zzbMg.zza((zzk<TResult>) zzi);
    ...
    public final Task<TResult> addOnSuccessListener(@NonNull Executor executor, @NonNull OnSuccessListener<? super TResult> onSuccessListener) {
        this.zzbMg.zza((zzk<TResult>) new zzi<TResult>(executor, onSuccessListener));
        zzDI();
        return this;
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWith(@NonNull Executor executor, @NonNull Continuation<TResult, TContinuationResult> continuation) {
        zzn zzn = new zzn();
        this.zzbMg.zza((zzk<TResult>) new zza<TResult>(executor, continuation, zzn));
        zzDI();
        return zzn;
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWithTask(@NonNull Executor executor, @NonNull Continuation<TResult, Task<TContinuationResult>> continuation) {
        zzn zzn = new zzn();
        this.zzbMg.zza((zzk<TResult>) new zzc<TResult>(executor, continuation, zzn));
        zzDI();
        return zzn;
    }
