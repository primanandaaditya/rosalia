...
public final class zzbcp extends GoogleApiClient implements zzbdq {
    ...
    public final void connect(int i) {
        ...
        try {
            zzbo.zzb(z, (Object) "Illegal sign-in mode: " + i);
            zzap(i);
            zzqc();
        } finally {
            this.zzaCv.unlock();
    ...
    public final <A extends zzb, R extends Result, T extends zzbay<R, A>> T zzd(@NonNull T t) {
        ...
        String str = t.zzpg() != null ? t.zzpg().getName() : "the API";
        zzbo.zzb(containsKey, (Object) new StringBuilder(String.valueOf(str).length() + 65).append("GoogleApiClient is not configured to use ").append(str).append(" required for this call.").toString());
        this.zzaCv.lock();
        try {
            if (this.zzaDz == null) {
                this.zzaCJ.add(t);
