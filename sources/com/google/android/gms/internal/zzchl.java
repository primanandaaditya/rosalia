...
public final class zzchl extends zzchj {
    ...
    public final void zzb(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        ...
        if (z && this.zzbtp != null && !zzex && !equals) {
            ...
            Bundle zza = super.zzwB().zza(str2, bundle, singletonList, z3, true);
            ...
            while (i3 < length) {
                ...
                if (zzC != null) {
                    ...
                    while (true) {
                        ...
                        Bundle zza2 = super.zzwB().zza("_ep", zzC[i5], singletonList, z3, false);
            ...
            while (true) {
                ...
                if (!bundle2.containsKey("_sc")) {
                    zzchz.zza((zzb) zzzh, bundle2);
                }
                Bundle bundle3 = z2 ? super.zzwB().zzB(bundle2) : bundle2;
                super.zzwF().zzyC().zze("Logging event (FE)", super.zzwA().zzdW(str2), super.zzwA().zzA(bundle3));
                super.zzww().zzc(new zzcez(str5, new zzcew(bundle3), str, j), str3);
                if (!equals) {
                    for (OnEventListener onEvent : this.zzbtq) {
                        onEvent.onEvent(str, str2, new Bundle(bundle3), j);
                    }
                }
                i6 = i7 + 1;
            }
    ...
    public final void zza(String str, String str2, Bundle bundle, boolean z) {
        super.zzwp();
        zza(str, str2, bundle, true, this.zzbtp == null || zzcjl.zzex(str2), true, null);
    }
    ...
    public final void zzd(String str, String str2, Bundle bundle) {
        super.zzwp();
        zza(str, str2, bundle, true, this.zzbtp == null || zzcjl.zzex(str2), false, null);
    }
