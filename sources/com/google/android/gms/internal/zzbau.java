...
public class zzbau extends zzbba {
    ...
    private final zza zzam(int i) {
        ...
        return (zza) this.zzaBB.get(this.zzaBB.keyAt(i));
    }
    ...
    public final void zza(int i, GoogleApiClient googleApiClient, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        zzbo.zza(this.zzaBB.indexOfKey(i) < 0, (Object) "Already managing a GoogleApiClient with id " + i);
    ...
    public final void zza(ConnectionResult connectionResult, int i) {
        ...
        if (zza2 != null) {
            zzal(i);
            OnConnectionFailedListener onConnectionFailedListener = zza2.zzaBE;
