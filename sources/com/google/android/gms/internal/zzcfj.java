...
public final class zzcfj extends zzchj {
        ...
        if (zzcjwArr != null) {
            for (zzcjw zzcjw : zzcjwArr) {
                if (zzcjw != null) {
                    ...
                    zza(sb, 2, NewHtcHomeBadger.COUNT, (Object) zzcjw.count);
    ...
    public final String zza(zzceu zzceu) {
        ...
        sb.append("', name='");
        sb.append(zzdW(zzceu.mName));
        sb.append("', params=");
        sb.append(zzb(zzceu.zzbpF));
        sb.append("}");
        return sb.toString();
    }
    ...
    public final String zza(zzcjn zzcjn) {
        ...
        zza(sb, 0, "event_name", (Object) zzdW(zzcjn.zzbuN));
    ...
    public final String zzb(zzcez zzcez) {
        ...
        sb.append(",name=");
        sb.append(zzdW(zzcez.name));
        sb.append(",params=");
        sb.append(zzb(zzcez.zzbpM));
        return sb.toString();
    }
    ...
    public final String zzdW(String str) {
        ...
        return zzyw() ? zza(str, Event.zzbog, Event.zzbof, zzbqI) : str;
    }
    ...
    public final String zzdX(String str) {
        ...
        return zzyw() ? zza(str, Param.zzboi, Param.zzboh, zzbqJ) : str;
    }
