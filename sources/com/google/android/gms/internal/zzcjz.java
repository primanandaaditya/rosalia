...
public final class zzcjz extends adj<zzcjz> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!adn.equals((Object[]) this.zzbvE, (Object[]) zzcjz.zzbvE)) {
            return false;
        }
        if (!adn.equals((Object[]) this.zzbvF, (Object[]) zzcjz.zzbvF)) {
            return false;
        }
        if (this.zzbvG == null) {
            if (zzcjz.zzbvG != null) {
        ...
        if (!adn.equals((Object[]) this.zzbvX, (Object[]) zzcjz.zzbvX)) {
            return false;
        }
        if (this.zzboY == null) {
            if (zzcjz.zzboY != null) {
        ...
        while (true) {
            ...
            switch (zzLA) {
                ...
                case 8:
                    ...
                    continue;
                case 18:
                    int zzb = C0158ads.zzb(adg, 18);
                    int length = this.zzbvE == null ? 0 : this.zzbvE.length;
                    zzcjw[] zzcjwArr = new zzcjw[(zzb + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzbvE, 0, zzcjwArr, 0, length);
                    }
                    while (length < zzcjwArr.length - 1) {
                        zzcjwArr[length] = new zzcjw();
                        adg.zza(zzcjwArr[length]);
                        adg.zzLA();
                        length++;
                    }
                    zzcjwArr[length] = new zzcjw();
                    ...
                    continue;
                case 26:
                    int zzb2 = C0158ads.zzb(adg, 26);
                    int length2 = this.zzbvF == null ? 0 : this.zzbvF.length;
                    zzckb[] zzckbArr = new zzckb[(zzb2 + length2)];
                    if (length2 != 0) {
                        System.arraycopy(this.zzbvF, 0, zzckbArr, 0, length2);
                    }
                    while (length2 < zzckbArr.length - 1) {
                        zzckbArr[length2] = new zzckb();
                        adg.zza(zzckbArr[length2]);
                        adg.zzLA();
                        length2++;
                    }
                    zzckbArr[length2] = new zzckb();
                ...
                case 224:
                    ...
                    continue;
                case 234:
                    int zzb3 = C0158ads.zzb(adg, 234);
                    int length3 = this.zzbvX == null ? 0 : this.zzbvX.length;
                    zzcjv[] zzcjvArr = new zzcjv[(zzb3 + length3)];
                    if (length3 != 0) {
                        System.arraycopy(this.zzbvX, 0, zzcjvArr, 0, length3);
                    }
                    while (length3 < zzcjvArr.length - 1) {
                        zzcjvArr[length3] = new zzcjv();
                        adg.zza(zzcjvArr[length3]);
                        adg.zzLA();
                        length3++;
                    }
                    zzcjvArr[length3] = new zzcjv();
    ...
    public final void zza(adh adh) throws IOException {
        ...
        if (this.zzbvX != null && this.zzbvX.length > 0) {
            for (zzcjv zzcjv : this.zzbvX) {
                if (zzcjv != null) {
                    adh.zza(29, (adp) zzcjv);
                }
            }
        }
        if (this.zzboY != null) {
