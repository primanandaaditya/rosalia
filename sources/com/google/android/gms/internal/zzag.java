...
public final class zzag implements zzb {
    ...
    static Map<String, String> zze(InputStream inputStream) throws IOException {
        ...
        Map<String, String> hashMap = zzb == 0 ? Collections.emptyMap() : new HashMap<>(zzb);
        for (int i = 0; i < zzb; i++) {
    ...
    public final synchronized void initialize() {
        ...
        L_0x002f:
            ...
            r8.zza(r6, r1)     // Catch:{ IOException -> 0x0077 }
    ...
    public final synchronized com.google.android.gms.internal.zzc zza(java.lang.String r11) {
        ...
        L_0x000d:
            ...
            return r0
        L_0x000f:
            java.io.File r4 = r10.zze(r11)     // Catch:{ all -> 0x00b0 }
            ...
            byte[] r5 = zza(r3, r2)     // Catch:{ IOException -> 0x00be, NegativeArraySizeException -> 0x00bc }
