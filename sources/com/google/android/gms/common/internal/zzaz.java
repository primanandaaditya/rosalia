    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            case 3:
                boolean zze = zze(parcel.readString(), zza.zzM(parcel.readStrongBinder()));
                parcel2.writeNoException();
                zzef.zza(parcel2, zze);
                break;
            case 4:
                boolean zzf = zzf(parcel.readString(), zza.zzM(parcel.readStrongBinder()));
                parcel2.writeNoException();
                zzef.zza(parcel2, zzf);
                break;
            case 5:
                boolean zza = zza((zzm) zzef.zza(parcel, zzm.CREATOR), zza.zzM(parcel.readStrongBinder()));
                parcel2.writeNoException();
