...
public final class zzl {
    ...
    private final Intent zzb(Bundle bundle, KeyPair keyPair) throws IOException {
        ...
        if (this.zzbhm == 0 || elapsedRealtime > this.zzbhm) {
            ...
            bundle.putString("sig", zza(keyPair, this.zzqD.getPackageName(), zzj));
    ...
    public static String zzbd(Context context) {
        ...
        if (!zzq.isAtLeastO()) {
            ...
            while (true) {
                if (it.hasNext()) {
                    if (zza(packageManager, ((ResolveInfo) it.next()).serviceInfo.packageName, "com.google.android.c2dm.intent.REGISTER")) {
                        zzbha = false;
                        z = true;
                        break;
                    }
                ...
                if (stringExtra == null) {
                    ...
                    if (stringExtra2.startsWith("|")) {
                        ...
                        if (split.length > 2) {
                            str = split[2];
                            String str7 = split[3];
                            stringExtra2 = str7.startsWith(":") ? str7.substring(1) : str7;
                        } else {
