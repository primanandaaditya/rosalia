...
final class zza {
    ...
    private final String zzhs(String str) {
        ...
        try {
            ...
            if (this.zzckU.invoke(notificationManager, new Object[]{"fcm_fallback_notification_channel"}) == null) {
                ...
                Object newInstance = cls.getConstructor(new Class[]{String.class, CharSequence.class, Integer.TYPE}).newInstance(new Object[]{"fcm_fallback_notification_channel", this.mContext.getString(C0155R.string.fcm_fallback_notification_channel_label), Integer.valueOf(3)});
    ...
    static Object[] zzi(Bundle bundle, String str) {
        ...
        try {
            ...
            Log.w(str2, new StringBuilder(String.valueOf(valueOf5).length() + 41 + String.valueOf(zze).length()).append("Malformed ").append(valueOf5).append(": ").append(zze).append("  Default value will be used.").toString());
            return null;
        }
    }
    ...
    private final String zzj(Bundle bundle, String str) {
        ...
        if (identifier == 0) {
            ...
            Log.w(str2, new StringBuilder(String.valueOf(valueOf3).length() + 49 + String.valueOf(zzh).length()).append(valueOf3).append(" resource not found: ").append(zzh).append(" Default value will be used.").toString());
            return null;
        }
